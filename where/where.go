...
func Equal(f string, v interface{}) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opEqual, false, v))
	return n
}
...
func Greater(f string, v interface{}) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opGreater, false, v))
	return n
}
...
func Less(f string, v interface{}) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opLess, false, v))
	return n
}
...
func Like(f string, v string) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opLike, false, v))
	return n
}
...
func In(f string, v interface{}) *Builder {
	values := convertToInterfaceArray(v)
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opIn, false, values...))
	return n
}
...
func Between(f string, v1 interface{}, v2 interface{}) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opBetween, false, v1, v2))
	return n
}
...
func IsNull(f string) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opIsNull, false))
	return n
}
...
func IsNotNull(f string) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opIsNull, true))
	return n
}
...
func NotEqual(f string, v interface{}) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opEqual, true, v))
	return n
}
...
func NotGreater(f string, v interface{}) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opGreater, true, v))
	return n
}
...
func NotLess(f string, v interface{}) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opLess, true, v))
	return n
}
...
func NotLike(f string, v string) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opLike, true, v))
	return n
}
...
func NotIn(f string, v interface{}) *Builder {
	values := convertToInterfaceArray(v)
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opIn, true, values...))
	return n
}
...
func NotBetween(f string, v1 interface{}, v2 interface{}) *Builder {
	n := newBuilder(conAnd)
	n.children = append(n.children, newClause(conAnd, f, opBetween, true, v1, v2))
	return n
}
...
func (c *Builder) AndEqual(f string, v interface{}) *Builder {
	c.children = append(c.children, newClause(conAnd, f, opEqual, false, v))
	return c
}
...
func (c *Builder) AndIn(f string, v interface{}) *Builder {
	values := convertToInterfaceArray(v)
	c.children = append(c.children, newClause(conAnd, f, opIn, false, values...))
	return c
}
...
func (c *Builder) AndNotEqual(f string, v interface{}) *Builder {
	c.children = append(c.children, newClause(conAnd, f, opEqual, true, v))
	return c
}
...
func (c *Builder) AndNotGreater(f string, v interface{}) *Builder {
	c.children = append(c.children, newClause(conAnd, f, opGreater, true, v))
	return c
}
...
func (c *Builder) AndNotLess(f string, v interface{}) *Builder {
	c.children = append(c.children, newClause(conAnd, f, opLess, true, v))
	return c
}
...
func (c *Builder) AndNotLike(f string, v string) *Builder {
	c.children = append(c.children, newClause(conAnd, f, opLike, true, v))
	return c
}
...
func (c *Builder) AndNotIn(f string, v interface{}) *Builder {
	values := convertToInterfaceArray(v)
	c.children = append(c.children, newClause(conAnd, f, opIn, true, values...))
	return c
}
...
func (c *Builder) AndNotBetween(f string, v1 interface{}, v2 interface{}) *Builder {
	c.children = append(c.children, newClause(conAnd, f, opBetween, true, v1, v2))
	return c
}
...
func (c *Builder) OrEqual(f string, v interface{}) *Builder {
	c.children = append(c.children, newClause(conOr, f, opEqual, false, v))
	return c
}
...
func (c *Builder) OrIn(f string, v interface{}) *Builder {
	values := convertToInterfaceArray(v)
	c.children = append(c.children, newClause(conOr, f, opIn, false, values...))
	return c
}
...
func (c *Builder) OrNotEqual(f string, v interface{}) *Builder {
	c.children = append(c.children, newClause(conOr, f, opEqual, true, v))
	return c
}
...
func (c *Builder) OrNotGreater(f string, v interface{}) *Builder {
	c.children = append(c.children, newClause(conOr, f, opGreater, true, v))
	return c
}
...
func (c *Builder) OrNotLess(f string, v interface{}) *Builder {
	c.children = append(c.children, newClause(conOr, f, opLess, true, v))
	return c
}

// OrNotLike add a not like clause to the clause with an OR conjunction
func (c *Builder) OrNotLike(f string, v string) *Builder {
	c.children = append(c.children, newClause(conOr, f, opLike, true, v))
	return c
}
...
func (c *Builder) OrNotContains(f string, v string) *Builder {
	c.children = append(c.children, newClause(conOr, f, opLike, true, "%"+string(v)+"%"))
	return c
}
...
func (c *Builder) OrNotIn(f string, v interface{}) *Builder {
	values := convertToInterfaceArray(v)
	c.children = append(c.children, newClause(conOr, f, opIn, true, values...))
	return c
}
...
func (c *Builder) OrNotBetween(f string, v1 interface{}, v2 interface{}) *Builder {
	c.children = append(c.children, newClause(conOr, f, opBetween, true, v1, v2))
	return c
}
